...
public class MainDeviceInfo extends Fragment {
		...
		try {
			...
			for (CellInfo info2 : tlfMan.getAllCellInfo()) {
				if (info2 instanceof CellInfoGsm
					...
					CellSignalStrengthGsm gsm = ((CellInfoGsm) info2)
					...
					CellSignalStrengthCdma cdma = ((CellInfoCdma) info2)
							.getCellSignalStrength();
					...
					CellSignalStrengthLte lte = ((CellInfoLte) info2)
							.getCellSignalStrength();
					dBm = lte.getDbm();
					level = lte.getLevel();
					...
					if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
						...
						int dBm = signalStrength.getGsmSignalStrength() * 2 - 113;
			...
			dataDeviceInfo.iconoDataMobile(level);
	...
	public void ActualizaDatosSincon() {
		...
		dataDeviceInfo.setTxtTipoRed(getActivity().getString(
				R.string.nodisponible));
		...
		dataDeviceInfo.setTxtMasSubred(getActivity().getString(
				R.string.nodisponible));
		dataDeviceInfo.setTxtDns1(getActivity()
				.getString(R.string.nodisponible));
		dataDeviceInfo.setTxtDns2(getActivity()
				.getString(R.string.nodisponible));
	...
	public void ActualizaDatosMobile(SignalStrength signalStrength) {
		...
		dataDeviceInfo.setTxtModelo(Build.MODEL);
		dataDeviceInfo.setTxtNombreRed(tlfMan.getNetworkOperatorName());
		dataDeviceInfo.setTxtTipoRed(con.getType(info.getType(), info
				.getSubtype(), getActivity()));
