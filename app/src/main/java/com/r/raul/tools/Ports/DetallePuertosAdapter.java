...
public class DetallePuertosAdapter extends RecyclerView.Adapter<DetallePuertosAdapter.Holder> {

    ArrayList<Puerto> array = new ArrayList<Puerto>();
    Activity activity;

    public DetallePuertosAdapter(Activity activity, ArrayList<Puerto> array) {
